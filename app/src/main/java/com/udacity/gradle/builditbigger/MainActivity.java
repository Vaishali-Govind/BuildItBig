...
public class MainActivity extends AppCompatActivity {
    ...
    private static ProgressBar mBarProgress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBarProgress = findViewById(R.id.Loaderjokeprogressbar);
    }
    ...
    public static void loadJokes(String task, Context context) {
        ...
        if(task.equals(context.getResources().getString(R.string.LoadingStarted))) {
            mBarProgress.setVisibility(View.VISIBLE);
        } else if(task.equals(context.getResources().getString(R.string.LoadingStopped))){
